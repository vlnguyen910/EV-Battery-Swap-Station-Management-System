...
import bg from "../../public/images/login_register_bg.jpg";
...
export default function Register({ onSubmit, loading, error, success }) {
  ...
  return (
    <div  className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-center bg-cover" 
