...
export default function Register({ onSubmit, loading, error, success }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[url(/src/public/images/login_register_bg.jpg)] bg-local">
