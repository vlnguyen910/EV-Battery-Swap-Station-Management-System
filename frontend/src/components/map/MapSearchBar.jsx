...
export default function MapSearchBar({ searchQuery, onSearch }) {
  return (
    <Card  className="bg-white-800 px-2 pb-2">
    <div className="bg-blue-800 px-4 py-3 rounded-lg shadow-md">
      <div className="flex items-center relative">
        ...
        <Button 
          size="sm"
          className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-blue-800 hover:bg-blue-900 text-white px-3 py-1 rounded-md text-xs h-7"
        >
          Search
        </Button>
      </div>
